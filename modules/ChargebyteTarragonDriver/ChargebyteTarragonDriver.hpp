...
#ifndef CHARGEBYTE_TARRAGONDRIVER_HPP
#define CHARGEBYTE_TARRAGONDRIVER_HPP
...
public:
    ChargebyteTarragonDriver() = delete;
    ChargebyteTarragonDriver(const ModuleInfo& info, Everest::MqttProvider& mqtt_provider,
...
#endif // CHARGEBYTE_TARRAGONDRIVER_HPP
