...
class ControlPilot {
public:
    ControlPilot(std::shared_ptr<ControlPilot_HAL> _control_pilot_hal, std::shared_ptr<PowerSwitch> _powerSwitch);
    ...
    void setSimulationData(float _sim_CPVoltage, float _sim_ppResistor, bool _sim_diodeFail, bool _sim_errorE,
...
private:
    ...
    std::shared_ptr<ControlPilot_HAL> control_pilot_hal;
    ...
    bool timerElapsed();
    std::chrono::milliseconds timerCountdown;
    std::chrono::time_point<std::chrono::steady_clock> timerTick;
